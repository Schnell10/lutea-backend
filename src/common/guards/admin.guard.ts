...
// Injectable : Décorateur qui permet à NestJS d'injecter ce guard dans d'autres classes (injection de dépendances)
...
// UserRole.ADMIN = 'admin', UserRole.CLIENT = 'client'
...
export class AdminGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    // Vérification 3 : L'utilisateur a-t-il le rôle ADMIN ?
    // currentUser.role : Rôle stocké en base de données
    // UserRole.ADMIN : Constante = 'admin'
